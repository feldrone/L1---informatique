...
<!-- LOCAL ADAPTATION (2026-09-21, feldrone/L1---informatique): les deux liens relatifs qui pointaient vers ../using-superpowers/references/ ont été réécrits vers references/ (copies incluses dans ce répertoire, car le skill compagnon using-superpowers n'est pas installé). Aucun autre changement au contenu amont. -->
