# REVISION MODE — plan de révision espacé
1. Input : module(s), échéance (date d'examen donnée par l'étudiant), points faibles déclarés, matière disponible dans le dépôt.
2. Squelette par session : (a) relire Cours/Chapitre (chemins HIGH d'abord) · (b) refaire 2-3 TD/Series questions · (c) examen chronométré issu de `…/Examens/` · (d) correction avec `pair-correction:` puis re-faire des erreurs.
