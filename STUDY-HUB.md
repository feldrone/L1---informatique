...
> ⚠️ Les PDF de l'archive proviennent de partages étudiants (toutes universités d'Algérie) ; ils ne remplacent pas le support officiel de votre enseignant. Les mentions « année » viennent du contenu des documents eux-mêmes.
## Semestre 1
...
| Anglais 1 / TCE | 24 | 7 | — | — | — | — | — | 2019-2020 · 2021-2022 | [24 docs](resources/incoming/study-materials/organized/S1/Anglais-1-TCE-1/) |
| Histoire | 1 | 1 | — | — | — | — | — | — | [1 docs](resources/incoming/study-materials/organized/S1/Histoire/) |

## Semestre 2 — 📭 pas encore de matériel d'étude

**Le lot uploadé à date est S1 uniquement.** Le cursus officiel S2 existe (`S2/` à la racine : Analyse 2, Algèbre 2, ASD 2, SM 2, Logique mathématique, IA, Électronique, Citoyenneté) mais **l'archive d'étude S2 n'a pas encore été fournie** — ajout prévue dans une phase séparée. Aucun fichier actuel n'est présenté comme matériel S2.

## Sans classification certaine (lot S1)
`organized/UNCLASSIFIED/` — 201 documents : scans sans texte, intitulés génériques, contenus évoquant d'autres semestres/filières (conservés, non éliminés, à réauditer quand le lot S2 arrivera). Recherche : `grep -i "mot" resources/incoming/study-materials/notes/study-index.md`.

## Trous connus (priorité)
- S1 : **Électricité générale 1 · Histoire 1 · Algèbre-1 20** documents — à compléter en priorité.
- S2 entier : matériel d'étude non uploadé (à venir).

## Liens rapides
- [Registre 627×19](resources/incoming/study-materials/notes/inventory.tsv)
- [Index par module](resources/incoming/study-materials/notes/study-index.md) · [Couverture & lacunes](resources/incoming/study-materials/notes/material-coverage.md) · [Carte modules↔cursus](resources/incoming/study-materials/notes/module-map.md)
- [Réconciliation](resources/incoming/study-materials/notes/reconciliation.md) · [Inventaire des 16 ZIP](resources/incoming/study-materials/notes/archive-inventory.tsv)
- [AI-STUDY-GUIDE](resources/incoming/study-materials/AI-STUDY-GUIDE.md) · [Skills d'étude](.github/skills/l1-study/SKILL.md)
